...
RIGHT_WRIST_MODEL_PATH = "/home/amro/IsaacLab_5/right_wrist_mapping_model_400_big.pt"
...
def load_learned_wrist_model(device):
    ...
    ckpt = torch.load(RIGHT_WRIST_MODEL_PATH, map_location=device)
...
print("RIGHT learned wrist mapping 400-big SPLIT architecture enabled")
